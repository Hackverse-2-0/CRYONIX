  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon-blue/20 rounded-full blur-3xl animate-pulse-slow"></div>
      </div>
      ...
      <div className="glass-card p-8 w-full max-w-md relative z-10 border-2 border-white/10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-200">Join the Mission</p>
        </div>
